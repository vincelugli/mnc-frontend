...
describe("mapStats", () => {
    ...
    it("should map a toxic stats response into a map of champion names to domain champions AND a collection of players", () => {
        ...
        expect(result.champions).toEqual(
            {Leona: { totalGames: 20, wins: 11, losses: 9, winPercentage: 55, name: "Leona"},
            Morgana: { totalGames: 10, losses: 8, wins: 2, winPercentage: 20, name: "Morgana" },
            "Dr. Mundo": { totalGames: 5, losses: 1, wins: 4, winPercentage: 80, name: "Dr. Mundo"}});
