...
const backgroundVideo ="https://screensavers.riotgames.com/v2/latest/content/original/AnimatedArt/animated-freljord.webm";
...
export default function Home() {
    ...
    const dataDragonResponse = useQuery<Champions, Error, {[key: string]: string}>(
        ["dataDragonChampions"],
        fetchChampions,
        {
            select: (data) => {
    ...
    useEffect(()=>{
        if (!dataDragonResponse.isLoading && dataDragonResponse.data !== undefined) {
            dispatch(GameInfoAction.hydrateChampionsComplete(dataDragonResponse.data));
        }
